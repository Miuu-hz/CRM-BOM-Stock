              ...
              <div className="absolute z-10 w-full mt-2 bg-[var(--surface-2)] border border-[var(--border)] rounded-lg shadow-lg max-h-60 overflow-y-auto">
                {(filteredProducts || []).map((product) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-[var(--primary)]">{product.category}</div>
                  </button>
                ))}
              </div>
            )}
            ...
            <div className="mt-4 p-4 bg-phopy-indigo/10 rounded-lg border border-phopy-indigo/30">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-semibold text-[var(--primary)]">{selectedBOM.version}</p>
                </div>
                <div>
          ...
          <div className="phopy-card p-4">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 bg-[var(--primary-soft)] text-[var(--primary)] border border-phopy-indigo/50 rounded-lg hover:bg-phopy-indigo/30 transition-colors"
              >
                ...
                <div key={cost.id} className="flex gap-2 items-center">
                  ...
                  {operatingCosts.length > 1 && (
                    <button
                      ...
                      className="p-2 text-danger hover:bg-[var(--danger-soft)] rounded transition-colors"
                    >
                      <X className="w-5 h-5" />
                    </button>
                  )}
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        {index === 0 && (
                          <span className="px-3 py-1 text-sm bg-[var(--success-soft)] text-success rounded-full font-semibold">
                            คุ้มที่สุด
                          </span>
                        )}
                      </div>
